...
function getUrlState(data) {
  ...
  var urlObj = (0, _objectSpread2.default)({
  ...
  return (0, _objectSpread2.default)({}, urlObj, {
    full: full,
    addons: addons,
    stories: stories,
...
function updateStore(queryParams, actions) {
  var selectedKind = queryParams.selectedKind,
      ...
      customQueryParams = (0, _objectWithoutProperties2.default)(queryParams, ["selectedKind", "selectedStory", "full", "down", "addons", "left", "stories", "panelRight", "downPanel", "addonPanel"]);
